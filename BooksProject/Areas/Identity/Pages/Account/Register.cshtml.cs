...
namespace BooksProject.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Admin Role for user(comment after making first admin) 
                    //await _userManager.AddToRoleAsync(user, SD.Role_Admin);  //Navneet@gmail.com Admin!2
